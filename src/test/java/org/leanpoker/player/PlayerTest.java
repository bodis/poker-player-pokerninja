...
public class PlayerTest {
    ...
    public void testParseGameState() throws Exception {
        ...
        GameState gameState = new Gson().fromJson(gameStateString, GameState.class);

        Assert.assertEquals(Suit.clubs, gameState.community_cards.get(2).suit);
        Assert.assertEquals(Status.active, gameState.players.get(0).status);
